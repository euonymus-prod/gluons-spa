  ...
  class WithAnonymous extends React.Component {
    ...
    fetchAnonymousUser = async () => {
      ...
      if (this.props.authUser) {
        ...
        authUser = await this.props.firebase.doSignInAnonymously().then( snapshot => snapshot.user )
      }
      this.setState({ authUser })
    }

    render() {
      return this.state.authUser ? <Component {...this.props} authUser={this.state.authUser} /> : null
    }
  }
